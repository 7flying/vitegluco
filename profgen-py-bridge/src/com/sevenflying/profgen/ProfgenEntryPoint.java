...
public class ProfgenEntryPoint {
	...
	public ProfgenEntryPoint getProfgen() {
		return this;
	}
	
	public void generateTwitter(PythonCallable python, String uuid, String name,
			...
			List<String> toFollow)
	{
		...
		base.logout();
		base.closeBrowser();
		python.sendResults(results);
	}

	public void generateTwitterEmail(PythonCallable python, String uuid,
			...
			String byear, List<String> toFollow)
	{
		...
		if (ex == null) {
			params.put(TwitterGenerator.emailParam, email);
			generateTwitter(python, uuid, name, lastname, username,
